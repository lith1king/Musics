...
client.user.setGame(`&play`,"https://www.twitch.tv/lovecrazy20")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
token=NTM1MTQ4OTI1NDc3MzIyNzgw.DyECLQ.5DTPZBRTsC0XA9jBSci6uD0bN5A
owner=526864822348808193
prefix= s
game= shelp | by:ezookik
stayinchannel=true
songinstatus=true 
